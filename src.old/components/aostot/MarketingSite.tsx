...
const SectionTitle = ({
  ...
  <div id={id} className="mx-auto max-w-3xl scroll-mt-24 text-center">
    {kicker ? (
          ...
          <ul className="mt-4 space-y-2 text-xs text-slate-700">
            {p.bullets.map((b) => (
              <li key={b} className="flex gap-2">
                <Check className="mt-0.5 h-3.5 w-3.5 text-slate-900" />
                <span>{b}</span>
              </li>
            ))}
          </ul>
...
export default function MarketingSite() {
  ...
  return (
    <div id="home" className="bg-gradient-to-b from-slate-50 to-white">
      {/* Header (Home/About/Pricing/Contact Us) */}
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/85 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <nav className="hidden items-center gap-6 text-sm font-semibold text-slate-700 sm:flex">
            ...
            <a href="\auth" className="hover:text-slate-900">App</a>
          </nav>
      ...
      <section id="contact" className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          <SectionTitle
            ...
            subtitle="This is a placeholder form. It can be wired to Supabase/Firebase/Airtable/HubSpot."
          />
